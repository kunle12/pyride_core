...
protected:
  ...
  virtual void onTelemetryData(const char cID, const RobotPose *pose,
  ...
  virtual void onVideoStreamSwitch(const char cID,
                                   const VideoSettings *vsettings) {}
...
private:
  ...
  void (*addRobotFn_)(const char, const int, const RobotInfo *,
                      const VideoSettings *, const AudioSettings *,
                      const unsigned char *, const int);
  void (*removeRobotFn_)(const char);
  void (*telemetryFn_)(const char, const RobotPose *, const FieldObject *,
                       const int);
  ...
  void (*operationalDataFn_)(const char, const int, const unsigned char *,
                             const int);
  ...
  void onRobotCreated(const char cID, const int ipAddr, const RobotInfo *rinfo,
                      const VideoSettings *vsettings,
                      const AudioSettings *assetings,
                      const unsigned char *optLabel, const int optLabelLength);
  void onRobotDestroyed(const char cID);
  void onRobotTelemetryData(const char cID, const RobotPose *pose,
                            const FieldObject *objects = NULL,
                            const int nofObjs = 0);
  ...
  void onExtendedCommandResponse(const char cID,
